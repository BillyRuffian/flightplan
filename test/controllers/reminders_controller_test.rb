...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference("Reminder.count") do
      post reminders_url, params: { reminder: { project_id: @reminder.project_id, start_date: @reminder.start_date, topic: @reminder.name } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { project_id: @reminder.project_id, start_date: @reminder.start_date, topic: @reminder.name } }
