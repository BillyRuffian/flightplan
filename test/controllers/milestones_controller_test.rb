...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference("Milestone.count") do
      post milestones_url, params: { milestone: { description: @milestone.description, end_date: @milestone.end_date, name: @milestone.name, project_id: @milestone.project_id, start_date: @milestone.start_date } }
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { description: @milestone.description, end_date: @milestone.end_date, name: @milestone.name, project_id: @milestone.project_id, start_date: @milestone.start_date } }
