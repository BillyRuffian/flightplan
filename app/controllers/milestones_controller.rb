class MilestonesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @milestone.save
        format.html { redirect_to project_milestone_url(@project, @milestone), notice: 'Milestone was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @milestone.update(milestone_params)
        format.html { redirect_to project_milestone_url(@project, @milestone), notice: 'Milestone was successfully updated.' }
